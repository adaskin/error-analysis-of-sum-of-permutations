...
figname = (
    "fig_q_vs_e_A_alpha{}{}_maxbit{}_terms{}".format(
...
axs[0].set_ylabel("Normalized MSE", fontsize=12)
...
axs[1].set_xlabel("The maximum value of the probability vector $q$",fontsize=12)
